...
- [ ] Создать модуль `services/nextPlaceService.ts`
- [ ] Реализовать функцию `getNextPlace()` - получение следующего места
- [ ] Логика: найти текущую поездку, найти первое место с `visited = false`

### 4.2 Экран "Следующее место"
- [ ] Создать экран `app/next-place/index.tsx`
- [ ] Отобразить информацию о следующем месте
- [ ] Показать фотографии места (если есть)
- [ ] Показать описание места
- [ ] Добавить кнопку "Открыть на карте"
- [ ] Добавить кнопку "Открыть в навигаторе"
- [ ] Добавить кнопку "Отметить как посещенное"
- [ ] Обработать случай, когда следующего места нет
...
### 5.1 Главный экран
- [ ] Создать/обновить экран `app/index.tsx`
- [ ] Добавить заголовок "GoNext"
- [ ] Создать вертикальный ряд кнопок:
  - "Места"
  - "Поездки"
  - "Следующее место"
  - "Настройки"
- [ ] Реализовать навигацию на соответствующие экраны
- [ ] Добавить визуальное оформление с использованием React Native Paper

### 5.2 Настройка навигации
- [ ] Настроить Stack Navigator для основных экранов
- [ ] Настроить навигацию между экранами
- [ ] Добавить кнопки "Назад" где необходимо
- [ ] Реализовать правильную структуру маршрутов
...
- [ ] Настроить `react-native-maps` или использовать Expo Location API
- [ ] Реализовать отображение места на карте
- [ ] Реализовать выбор координат через карту
- [ ] Добавить маркеры для мест в поездке
- [ ] Реализовать отображение маршрута (опционально для MVP)

### 6.2 Интеграция с навигаторами
- [ ] Реализовать открытие места в Google Maps (Android)
- [ ] Реализовать открытие места в Apple Maps (iOS)
- [ ] Использовать deep linking для открытия навигатора с координатами
...
- [ ] Создать модуль `services/photosService.ts`
- [ ] Реализовать сохранение фотографий в файловую систему
- [ ] Реализовать получение пути к фотографии
- [ ] Реализовать удаление фотографий
- [ ] Реализовать связь фотографий с местами и поездками в БД

### 7.2 Компоненты для работы с фотографиями
- [ ] Создать компонент для выбора фотографии из галереи
- [ ] Создать компонент для отображения фотографий
- [ ] Создать компонент галереи фотографий
...
- [ ] Создать экран `app/settings/index.tsx`
- [ ] Добавить базовые настройки (если нужны для MVP)
- [ ] Добавить информацию о приложении
- [ ] Добавить возможность экспорта данных (для будущего развития)
